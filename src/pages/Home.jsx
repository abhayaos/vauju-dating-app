...
function Home() {
  ...
  const SkeletonLoader = () => (
    <div className="animate-pulse">
      <div className="h-16 bg-gray-800 rounded w-3/4 mx-auto mb-8"></div>
      <div className="h-12 bg-gray-800 rounded w-1/2 mx-auto mb-16"></div>
    ...
    <div className="min-h-screen bg-black flex flex-col">
      ...
      <div className="flex-grow flex flex-col items-center justify-center p-4">
        <div className="text-center max-w-2xl w-full">
          ...
          <p className="text-2xl md:text-3xl text-indigo-400 font-semibold animate-pulse">
            Coming Soon
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-col items-center mb-4 md:mb-0">
              <p className="text-gray-400 text-sm">Founded by Abhaya Bikram Shahi</p>
            </div>
