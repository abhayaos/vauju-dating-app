  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:title" content="Yugal Meet - Connect with Like-Minded People | Coming Soon" />
        ...
        <meta property="twitter:title" content="Yugal Meet - Connect with Like-Minded People | Coming Soon" />
      ...
      <div className="min-h-screen bg-black flex flex-col">
          ...
          <div className="text-center max-w-2xl w-full">
            ...
            <div className="mt-8">
              ...
              <div className="flex justify-center space-x-3">
                ...
                <div className="w-2 h-2 bg-indigo-500 rounded-full animate-bounce" style={{ animationDelay: '0.4s' }} aria-hidden="true"></div>
              </div>
            </div>
          </div>
        </main>
        ...
        {/* Footer */}
        <footer className="py-6 border-t border-gray-800" role="contentinfo">
