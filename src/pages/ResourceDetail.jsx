    ...
    resources: [
      {
        ...
        content: `
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Creating Your Profile</h2>
          <p>Your profile is your first impression on Yugal Meet. Make sure to:</p>
          <ul class="list-disc list-inside text-gray-700 ml-6 mt-3 space-y-2">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Finding Matches</h2>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Messaging Tips</h2>
      ...
      },
      {
        ...
        content: `
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Photo Tips</h2>
          <ul class="list-disc list-inside text-gray-700 ml-6 mt-3 space-y-2">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Bio Writing</h2>
          <ul class="list-disc list-inside text-gray-700 ml-6 mt-3 space-y-2">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Interest Selection</h2>
    ...
    resources: [
      {
        ...
        content: `
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Protecting Your Personal Information</h2>
          <ul class="list-disc list-inside text-gray-700 ml-6 mt-3 space-y-2">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Meeting in Person</h2>
          <ul class="list-disc list-inside text-gray-700 ml-6 mt-3 space-y-2">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Recognizing Scams</h2>
      ...
      },
      {
        ...
        content: `
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Respectful Communication</h2>
          <ul class="list-disc list-inside text-gray-700 ml-6 mt-3 space-y-2">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Authenticity</h2>
          <ul class="list-disc list-inside text-gray-700 ml-6 mt-3 space-y-2">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Prohibited Content</h2>
          <ul class="list-disc list-inside text-gray-700 ml-6 mt-3 space-y-2">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Consequences of Violations</h2>
      ...
      <div className="min-h-screen bg-gradient-to-br from-white to-gray-100 flex flex-col">
        <main className="flex-grow flex items-center justify-center p-4">
          <div className="text-center max-w-2xl">
            <h1 className="text-4xl font-bold text-gray-900 mb-6">Resource Not Found</h1>
        ...
        <main className="flex-grow p-4 md:p-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-2xl p-6 md:p-8 border border-gray-200 shadow-sm">
              <div 
                className="resource-content text-gray-900"
            ...
            <div className="flex flex-col sm:flex-row justify-between gap-4 mt-8">
              <Link 
                to="/help-resources" 
                className="inline-flex items-center bg-gray-100 hover:bg-gray-200 text-gray-900 font-semibold py-3 px-6 rounded-lg transition-colors"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 19l-7-7m0 0l7-7m-7 7h18" />
                </svg>
