          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {activeCategoryData.resources.map((resource, index) => (
                <div 
                  key={index} 
                  className="bg-gray-900/80 backdrop-blur-sm rounded-xl p-6 border border-gray-800 hover:border-indigo-500 transition-all duration-300 flex flex-col"
                  style={{ minHeight: '200px' }}
                >
                  <h2 className="text-2xl font-bold text-white mb-3">{resource.title}</h2>
