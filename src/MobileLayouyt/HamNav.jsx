...
function HamNav() {
  ...
  return (
    <div className="bg-gray-50 md:ml-18 ml-0 min-h-screen text-gray-800 transition-all duration-300">
      ...
      <div className="mt-5 bg-white mx-4 rounded-2xl shadow-md border border-gray-100 divide-y divide-gray-100">
        {menuItems.map((item, index) => (
          <div
            ...
            className="flex items-center gap-4 p-4 hover:bg-gray-50 active:scale-[0.99] cursor-pointer transition-all"
          >
